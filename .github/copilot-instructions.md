...
- **Agent signature:** End the body with a blank line followed by an agent signature identifying the agent that generated the commit. Copilot CLI uses `Copilot - <model>`, Claude Code uses `Claude - <model>`.
