...
# Generate aliases.nu (written directly to avoid nu deleting stow-managed symlink targets)
mut _aliases = [
...
$_aliases | str join (char newline) | save -f $"($env.HOME)/.config/nushell/aliases.nu"
